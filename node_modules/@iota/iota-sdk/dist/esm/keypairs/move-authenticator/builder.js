class InvalidMoveAuthArgError extends Error {
  constructor(message) {
    super(message);
    this.name = "InvalidMoveAuthArgError";
  }
}
class InvalidMoveAuthAccountError extends Error {
  constructor(message) {
    super(message);
...
class MoveAuthenticatorBuilder {
   ...
   */
  constructor(objectToAuthenticate) {
    this.callArgs = [];
    this.typeArgs = [];
   ...
   * @returns this builder for chaining
   */
  addSharedObject(objectId, mutable = false) {
  ...
  async finish(client) {
    ...
    } else if (objectToAuthenticateOwner && typeof objectToAuthenticateOwner === "object" && "Shared" in objectToAuthenticateOwner) {
      objectToAuthenticate = {
        SharedObject: {
          objectId: objectToAuthenticateData.objectId,
