...
export declare class IotaClient {
    ...
    executeTransactionBlock({ transactionBlock, signature, options, signal, }: ExecuteTransactionBlockParams): Promise<IotaTransactionBlockResponse>;
     ...
     */
    getLatestIotaSystemStateV1({ signal, }?: {
        signal?: AbortSignal;
     ...
     */
    getLatestIotaSystemStateV2({ signal, }?: {
        signal?: AbortSignal;
     ...
     */
    getLatestIotaSystemState({ signal, }?: {
        signal?: AbortSignal;
     ...
     * Uses the V2.
     */
    getDynamicFieldObject(input: GetDynamicFieldObjectV2Params): Promise<IotaObjectResponse>;
    /**
     * Return the dynamic field object information for a specified object
     * @deprecated `getDynamicFieldObjectV1` is deprecated, prefer to use `getDynamicFieldObject` which uses V2.
     */
    getDynamicFieldObjectV1(input: GetDynamicFieldObjectParams): Promise<IotaObjectResponse>;
    /**
     ...
     */
    getLatestCheckpointSequenceNumber({ signal, }?: {
        signal?: AbortSignal;
    }): Promise<string>;
    /**
     ...
     */
    getParticipationMetrics({ signal, }?: {
        signal?: AbortSignal;
     ...
     */
    waitForTransaction({ signal, timeout, pollInterval, waitMode, ...input }: {
     ...
     */
    isTransactionIndexedOnNode(input: IsTransactionIndexedOnNodeParams): Promise<boolean>;
    /**
     * Calls a move view function.
     */
    view(input: ViewParams): Promise<IotaMoveViewCallResults>;
}
export {};
