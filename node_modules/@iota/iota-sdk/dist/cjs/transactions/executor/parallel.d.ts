import type { IotaClient, IotaTransactionBlockResponse, IotaTransactionBlockResponseOptions } from '../../client/index.js';
...
export declare class ParallelTransactionExecutor {
    ...
    executeTransaction(transaction: Transaction, options?: IotaTransactionBlockResponseOptions, additionalSignatures?: string[]): Promise<{
        digest: string;
        effects: string;
