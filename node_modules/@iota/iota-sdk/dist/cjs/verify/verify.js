...
var import_publickey6 = require("../keypairs/move-authenticator/publickey.js");
...
function parseSignature(signature) {
  ...
  if (parsedSignature.signatureScheme === "MoveAuthenticator") {
    const authenticatedObjectId = parsedSignature.moveAuthenticator.objectToAuthenticate.Object?.$kind === "ImmOrOwnedObject" ? parsedSignature.moveAuthenticator.objectToAuthenticate.Object.ImmOrOwnedObject.objectId : parsedSignature.moveAuthenticator.objectToAuthenticate.Object?.$kind === "Receiving" ? parsedSignature.moveAuthenticator.objectToAuthenticate.Object.Receiving.objectId : parsedSignature.moveAuthenticator.objectToAuthenticate.Object?.SharedObject?.objectId;
    return {
      ...parsedSignature,
      publicKey: new import_publickey6.MoveAuthenticatorPublicKey(authenticatedObjectId)
    };
  }
...
function publicKeyFromRawBytes(signatureScheme, bytes) {
  switch (signatureScheme) {
    ...
    case "MoveAuthenticator":
      return new import_publickey6.MoveAuthenticatorPublicKey(bytes);
    default:
