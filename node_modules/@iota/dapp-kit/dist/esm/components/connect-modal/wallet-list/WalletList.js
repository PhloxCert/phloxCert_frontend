...
function WalletListItem({ name, icon: icon2, onClick, isSelected = false }) {
  return /* @__PURE__ */ jsx3("li", { className: container2, children: /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      onClick,
      children: [
        icon2 && typeof icon2 === "string" ? /* @__PURE__ */ jsx3("img", { className: walletIcon, src: icon2, alt: `${name} logo` }) : icon2,
...
function WalletList({ selectedWalletName, onPlaceholderClick, onSelect }) {
  ...
  return /* @__PURE__ */ jsx4("ul", { className: container, children: wallets.length > 0 ? wallets.map((wallet) => /* @__PURE__ */ jsx4(
    ...
    {
      name: "IOTA Wallet",
      icon: /* @__PURE__ */ jsx4(IotaIcon, { className: icon }),
