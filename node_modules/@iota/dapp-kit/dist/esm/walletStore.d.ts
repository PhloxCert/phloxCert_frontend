...
export declare function createWalletStore({ wallets, storage, storageKey, autoConnectEnabled, chain, }: WalletConfiguration): Omit<import("zustand").StoreApi<StoreState>, "persist"> & {
    persist: {
