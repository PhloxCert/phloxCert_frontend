...
var import_client2 = require("@iota/iota-sdk/client");
var import_react_query3 = require("@tanstack/react-query");
var import_iota_names_sdk = require("@iota/iota-names-sdk");
...
var IotaClientContext = (0, import_react6.createContext)(null);
...
function useIotaClientContext() {
  const iotaClient = (0, import_react7.useContext)(IotaClientContext);
  if (!iotaClient) {
    throw new Error(
...
var import_graphql = require("@iota/iota-sdk/graphql");
function useGetDefaultIotaName(address, iotaNamesEnabled) {
  const iotaContext = useIotaClientContext();
  const network = (0, import_client2.getNetwork)(iotaContext.network);
  const iotaNamesClient = (0, import_react8.useMemo)(() => {
    const iotaGraphQLClient = new import_graphql.IotaGraphQLClient({
      url: network.graphql
    });
    return new import_iota_names_sdk.IotaNamesClient({
  ...
  return (0, import_react_query3.useQuery)({
    ...
    queryFn: async () => {
      ...
      return name ? (0, import_iota_names_sdk.normalizeIotaName)(name) : name;
    },
...
function AccountDropdownMenu({
  ...
  const displayAccount = iotaName ?? currentAccount.label ?? (0, import_utils.formatAddress)(currentAccount.address);
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(DropdownMenu.Root, { modal: false, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(StyleMarker, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(DropdownMenu.Trigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Button, { size, className: connectedAccount, children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Text, { mono: true, weight: "bold", children: displayAccount }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(DropdownMenu.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(StyleMarker, { className: menuContainer, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(DropdownMenu.Content, { className: menuContent, children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: scrollableContent, children: accounts.map((account) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
...
function AccountDropdownMenuItem({
  ...
  const displayAccount = iotaName ?? account.label ?? (0, import_utils.formatAddress)(account.address);
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
    DropdownMenu.Item,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Text, { mono: true, children: displayAccount }),
...
function ConnectionStatus({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: container2, children: [
    ...
    hadConnectionError ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: retryButtonContainer, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      Button,
      {
        type: "button",
        variant: "primary",
...
function GettingStarted() {
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: container4, children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Heading, { as: "h2", children: "Get Started with IOTA" }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: content2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(InfoSection, { title: "Install the IOTA Wallet Extension", children: "We recommend pinning IOTA Wallet to your taskbar for quicker access." }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: installButtonContainer, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Button, { variant: "primary", asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        "a",
        {
...
function WalletListItem({ name, icon: icon2, onClick, isSelected = false }) {
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("li", { className: container7, children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        icon2 && typeof icon2 === "string" ? /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("img", { className: walletIcon2, src: icon2, alt: `${name} logo` }) : icon2,
...
function WalletList({ selectedWalletName, onPlaceholderClick, onSelect }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("ul", { className: container6, children: wallets.length > 0 ? wallets.map((wallet) => /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
    ...
    {
      name: "IOTA Wallet",
      icon: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(IotaIcon, { className: icon }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Dialog.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(StyleMarker, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Dialog.Overlay, { className: overlay, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(Dialog.Content, { className: content, "aria-describedby": void 0, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: backButtonContainer, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
              IconButton,
              {
                type: "button",
                "aria-label": "Back",
                onClick: () => resetSelection(),
                children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(BackIcon, {})
              }
            ) }),
            modalContent
          ]
...
function ConnectButton({
  ...
  return currentAccount ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
    AccountDropdownMenu,
    {
      currentAccount,
      size,
    ...
    {
      onConnected,
      trigger: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(StyleMarker, { children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Button, { ...buttonProps, size, children: connectText }) })
    }
  );
}
