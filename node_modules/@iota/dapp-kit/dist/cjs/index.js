...
__export(index_exports, {
  ...
  darkTheme: () => darkTheme,
  getIotaClientQuery: () => getIotaClientQuery,
  ...
  useIotaClientSuspenseQuery: () => useIotaClientSuspenseQuery,
...
function WalletListItem({ name, icon: icon2, onClick, isSelected = false }) {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("li", { className: container7, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        icon2 && typeof icon2 === "string" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("img", { className: walletIcon2, src: icon2, alt: `${name} logo` }) : icon2,
...
function IotaClientProvider(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(IotaClientContext.Provider, { value: ctx, children });
}

// src/hooks/useIotaClient.ts
function useIotaClientContext() {
  const iotaClient = (0, import_react10.useContext)(IotaClientContext);
  if (!iotaClient) {
    throw new Error(
...
function useGetDefaultIotaName(address, iotaNamesEnabled) {
  ...
  const iotaNamesClient = (0, import_react11.useMemo)(() => {
...
function AccountDropdownMenu({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(DropdownMenu.Root, { modal: false, children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(StyleMarker, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(DropdownMenu.Trigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(Button, { size, className: connectedAccount, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Text, { mono: true, weight: "bold", children: displayAccount }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(DropdownMenu.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(StyleMarker, { className: menuContainer, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(DropdownMenu.Content, { className: menuContent, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: scrollableContent, children: accounts.map((account) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
...
function AccountDropdownMenuItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
    DropdownMenu.Item,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Text, { mono: true, children: displayAccount }),
...
function useIotaClientSuspenseQuery(...args) {
  ...
  const iotaContext = useIotaClientContext();
  const query = (0, import_react17.useMemo)(() => {
  ...
  return (0, import_react_query8.useSuspenseQuery)(query);
}
...
function useIotaClientQueries({
  ...
  const iotaContext = useIotaClientContext();
  return (0, import_react_query9.useQueries)({
    combine,
