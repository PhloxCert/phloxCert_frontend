...
*/
module.exports.createClient = function(clientOptions) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(clientOptions, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        wasm.createClient(retptr, ptr0, len0);
        ...
        return ClientMethodHandler.__wrap(r0);
    } finally {
...
*/
module.exports.destroyClient = function(_client_method_handler) {
    _assertClass(_client_method_handler, ClientMethodHandler);
    const ret = wasm.destroyClient(_client_method_handler.__wbg_ptr);
...
*/
module.exports.callClientMethodAsync = function(method, methodHandler) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(method, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        _assertClass(methodHandler, ClientMethodHandler);
        wasm.callClientMethodAsync(retptr, ptr0, len0, methodHandler.__wbg_ptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
*/
module.exports.listenMqtt = function(_topics, _callback) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.listenMqtt(retptr, addHeapObject(_topics), addBorrowedObject(_callback));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        if (r1) {
            throw takeObject(r0);
...
*/
module.exports.createSecretManager = function(options) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(options, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        wasm.createSecretManager(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
        ...
        return SecretManagerMethodHandler.__wrap(r0);
    } finally {
        wasm.__wbindgen_add_to_stack_pointer(16);
    }
};
...
* @returns {Promise<string>}
*/
module.exports.callSecretManagerMethodAsync = function(method, methodHandler) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(method, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        _assertClass(methodHandler, SecretManagerMethodHandler);
        wasm.callSecretManagerMethodAsync(retptr, ptr0, len0, methodHandler.__wbg_ptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
*/
module.exports.migrateStrongholdSnapshotV2ToV3 = function(_current_path, _current_password, _salt, _rounds, _new_path, _new_password) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(_current_path, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(_current_password, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(_salt, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len2 = WASM_VECTOR_LEN;
        var ptr3 = isLikeNone(_new_path) ? 0 : passStringToWasm0(_new_path, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        var len3 = WASM_VECTOR_LEN;
        var ptr4 = isLikeNone(_new_password) ? 0 : passStringToWasm0(_new_password, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        var len4 = WASM_VECTOR_LEN;
        wasm.migrateStrongholdSnapshotV2ToV3(retptr, ptr0, len0, ptr1, len1, ptr2, len2, _rounds, ptr3, len3, ptr4, len4);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        if (r1) {
            throw takeObject(r0);
...
* @returns {any}
*/
module.exports.callUtilsMethodRust = function(method) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(method, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
...
*/
module.exports.createWallet = function(options) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(options, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        wasm.createWallet(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
        ...
        return WalletMethodHandler.__wrap(r0);
    } finally {
        wasm.__wbindgen_add_to_stack_pointer(16);
    }
};
...
* @returns {Promise<void>}
*/
module.exports.destroyWallet = function(method_handler) {
    _assertClass(method_handler, WalletMethodHandler);
    const ret = wasm.destroyWallet(method_handler.__wbg_ptr);
    return takeObject(ret);
};
...
*/
module.exports.getClientFromWallet = function(method_handler) {
    _assertClass(method_handler, WalletMethodHandler);
    const ret = wasm.getClientFromWallet(method_handler.__wbg_ptr);
    return takeObject(ret);
};
...
*/
module.exports.getSecretManagerFromWallet = function(method_handler) {
    _assertClass(method_handler, WalletMethodHandler);
    const ret = wasm.getSecretManagerFromWallet(method_handler.__wbg_ptr);
    return takeObject(ret);
};
...
* @returns {Promise<string>}
*/
module.exports.callWalletMethodAsync = function(method, method_handler) {
    const ptr0 = passStringToWasm0(method, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
    const len0 = WASM_VECTOR_LEN;
    _assertClass(method_handler, WalletMethodHandler);
    const ret = wasm.callWalletMethodAsync(ptr0, len0, method_handler.__wbg_ptr);
    return takeObject(ret);
};
...
* @returns {Promise<any>}
*/
module.exports.listenWalletAsync = function(vec, callback, method_handler) {
    _assertClass(method_handler, WalletMethodHandler);
    const ret = wasm.listenWalletAsync(addHeapObject(vec), addHeapObject(callback), method_handler.__wbg_ptr);
    return takeObject(ret);
};
...
*/
module.exports.migrateDbChrysalisToStardust = function(_storage_path, _password) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(_storage_path, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(_password) ? 0 : passStringToWasm0(_password, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        var len1 = WASM_VECTOR_LEN;
        wasm.migrateDbChrysalisToStardust(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        if (r1) {
            throw takeObject(r0);
...
module.exports.initLogger = function(_config) {
    const ptr0 = passStringToWasm0(_config, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
    const len0 = WASM_VECTOR_LEN;
...
module.exports.ClientMethodHandler = ClientMethodHandler;
...
module.exports.SecretManagerMethodHandler = SecretManagerMethodHandler;

const WalletMethodHandlerFinalization = new FinalizationRegistry(ptr => wasm.__wbg_walletmethodhandler_free(ptr >>> 0));
/**
...
class WalletMethodHandler {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WalletMethodHandler.prototype);
        obj.__wbg_ptr = ptr;
        WalletMethodHandlerFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WalletMethodHandlerFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_walletmethodhandler_free(ptr);
    }
}
module.exports.WalletMethodHandler = WalletMethodHandler;
...
module.exports.__wbg_clientmethodhandler_new = function(arg0) {
...
module.exports.__wbg_secretmanagermethodhandler_new = function(arg0) {
    const ret = SecretManagerMethodHandler.__wrap(arg0);
    return addHeapObject(ret);
};

module.exports.__wbg_error_1f4e3e298a7c97f6 = function(arg0) {
...
module.exports.__wbg_keys_7dc65b03a1d1e0a3 = function(arg0) {
...
module.exports.__wbg_text_10c88c5e55f873c7 = function() { return handleError(function (arg0) {
...
module.exports.__wbg_now_65ff8ec2b863300c = function(arg0) {
...
module.exports.__wbg_error_8cf137381b3af25f = function(arg0, arg1, arg2, arg3) {
    console.error(getObject(arg0), getObject(arg1), getObject(arg2), getObject(arg3));
};

module.exports.__wbg_warn_ea08466617ec5d3a = function(arg0, arg1, arg2, arg3) {
    console.warn(getObject(arg0), getObject(arg1), getObject(arg2), getObject(arg3));
};

module.exports.__wbg_info_eb81e4fcae9ba8f1 = function(arg0, arg1, arg2, arg3) {
    console.info(getObject(arg0), getObject(arg1), getObject(arg2), getObject(arg3));
};

module.exports.__wbg_log_bd0951a507fbf762 = function(arg0, arg1, arg2, arg3) {
    console.log(getObject(arg0), getObject(arg1), getObject(arg2), getObject(arg3));
};

module.exports.__wbg_debug_0207b724052e591d = function(arg0, arg1, arg2, arg3) {
...
module.exports.__wbindgen_closure_wrapper3069 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 150, __wbg_adapter_28);
    return addHeapObject(ret);
};

module.exports.__wbindgen_closure_wrapper5130 = function(arg0, arg1, arg2) {
