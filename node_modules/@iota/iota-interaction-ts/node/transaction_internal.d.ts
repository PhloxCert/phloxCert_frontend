...
export interface TransactionBuilder<T extends Transaction<unknown>> {
    ...
    executeWithGasStation<S extends TransactionSigner>(client: CoreClient<S>, gasStationUrl: string, httpClient: HttpClient, options?: GasStationParamsI): Promise<TransactionOutput<T>>;
}
