...
__export(helpers_exports, {
  ...
  getCoreConfigType: () => getCoreConfigType,
  getDenyListType: () => getDenyListType,
  getNameRegistrationType: () => getNameRegistrationType,
  getNameType: () => getNameType,
  getPricelistConfigType: () => getPricelistConfigType,
  getRegistryKeyType: () => getRegistryKeyType,
  getRenewalPricelistConfigType: () => getRenewalPricelistConfigType,
  getSubnameRegistrationType: () => getSubnameRegistrationType,
  getSubnamesConfigType: () => getSubnamesConfigType,
...
function isSubname(name) {
  return (0, import_utils.normalizeIotaName)(name, "dot").split(".").length > 2;
}
function isNestedSubname(name) {
  return (0, import_utils.normalizeIotaName)(name, "dot").split(".").length > 3;
}
...
function getRegistryKeyType(iotaNamesPackageId, innerType) {
...
function getDenyListType(iotaNamesPackageId) {
  return `${iotaNamesPackageId}::deny_list::DenyList`;
}
function getSubnamesConfigType(iotaNamesPackageId) {
